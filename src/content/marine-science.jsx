...
const ITEMS = [
  ...
  { id: "U1-91", topic: "inside", type: "exam", tier: 3, ref: "1.1/LO3",
  ...
  { id: "U1-93", topic: "space", type: "exam", tier: 3, ref: "1.1/LO2", family: "orbits-gravity",
    ...
    check: ["the Earth is a planet that travels in orbit around the Sun", "the Moon is the Earth's natural satellite", "the Moon travels in orbit around the Earth", "gravity is the pulling force between masses", "the Sun's gravity keeps the Earth in orbit around the Sun", "the Earth's gravity keeps the Moon in orbit around the Earth"],
    ...
    build: ["The Earth is a planet that travels in orbit around the Sun.", "The Moon is the Earth's natural satellite,", "and it travels in orbit around the Earth.", "Gravity, the pulling force between masses, is what holds these orbits together:", "the Sun's gravity keeps the Earth circling the Sun,", "and the Earth's gravity keeps the Moon circling the Earth."],
    why: "Combines 1.1/LO1 (describe the orbital hierarchy) with 1.1/LO2 (state that gravity keeps the orbits) into a describe+explain. 'Gravity keeps... in orbit' kept verbatim — it is the syllabus statement, not an over-reach. Distractors: 'Moon orbits the Sun independently', 'magnetism holds the Moon', 'solar wind pushes the Moon' — all cleanly-wrong forces/ideas (round-4: the old 'Sun's gravity holds the Moon' distractor was replaced because the Sun does exert large gravity on the Moon, so it was not cleanly false). Demand ~4 marks (assembled from two recall/state outcomes), not a genuine 6-marker." },
  ...
  { id: "Q13", topic: "plates", type: "choice", tier: 1, ref: "1.2/LO3",
  ...
  { id: "G5", topic: "plates", type: "choice", tier: 2, ref: "1.2/LO3",
  ...
  { id: "U1-100", topic: "oceans", type: "exam", tier: 3, ref: "1.3/LO4", family: "ocean-figures",
    q: "Describe the extent and the depth of the Earth's oceans, using the key facts and figures.",
    check: ["the oceans cover about 71 per cent of the Earth's surface", "they hold about 97 per cent of all the water on Earth", "the Pacific Ocean is the largest of the oceans", "the deepest point in the oceans is the Mariana Trench", "the Mariana Trench reaches a maximum depth of about 11 000 metres"],
    distractors: ["the oceans cover about 29 per cent of the Earth's surface", "the Atlantic Ocean is the largest of the oceans", "the deepest point is a mid-ocean ridge, about 1 100 metres down"],
    build: ["The oceans cover about 71 per cent of the Earth's surface,", "and they hold about 97 per cent of all the water on Earth.", "Of the five oceans, the Pacific Ocean is the largest.", "The deepest point anywhere in the oceans is the Mariana Trench,", "which reaches a maximum depth of about 11 000 metres."],
    why: "Assembles the three 1.3/LO4 'limited to' facts (71 %% surface, 97 %% water, Pacific largest, Mariana ~11 000 m) into a 'describe the extent and depth' answer — command word 'describe' is in the LO, and these are the only examinable numbers in the unit, kept verbatim. Distractors are the KM's exact numeric mis-steps: 29 %% (land share), Atlantic-largest, and a ridge at 1 100 m (deepest-point + factor-of-ten error). FLAG for vetting: recall-stacked describe, not a reasoning question; an examiner would more likely split these into one-markers. Included to meet the 1.3 target of 4." },
