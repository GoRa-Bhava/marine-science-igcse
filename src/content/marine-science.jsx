...
const TOPICS = [
  ...
  { id: "u1-tectonics",  unit: 1, name: "Plate tectonics",            depth: "How ocean features form" },
  { id: "u2-upwelling",  unit: 2, name: "Upwelling",                  depth: "Nutrients back to the surface" },
...
const ITEMS = [
  ...
  { id: "u1-tc1", topic: "u1-tectonics", type: "choice",
    q: "What are tectonic plates?",
    options: ["Large sections of the Earth's outer layer that move slowly over the mantle", "Layers of sediment on the deep-sea floor", "Warm currents that circle the oceans", "Ridges built up by coral growth"],
    a: 0,
    why: "The Earth's rigid outer layer is broken into plates that move slowly over the mantle beneath." },
  { id: "u1-tc2", topic: "u1-tectonics", type: "choice",
    q: "What forms where two ocean plates move apart and magma rises between them?",
    options: ["A mid-ocean ridge, as new sea floor is created", "A deep ocean trench", "A coral atoll", "A sandy shore"],
    a: 0,
    why: "At a divergent (constructive) boundary, rising magma forms new sea floor — sea-floor spreading — building mid-ocean ridges.",
    reflect: { prompt: "In your own words, why is the sea floor youngest at a mid-ocean ridge and older further away?", model: "New crust is made at the ridge as the plates spread apart, pushing older crust outwards, so the further from the ridge, the older the sea floor." } },
  { id: "u1-tc3", topic: "u1-tectonics", type: "choice",
    q: "What ocean feature forms where a dense oceanic plate is forced down beneath another plate?",
    options: ["A deep ocean trench", "A mid-ocean ridge", "A shallow lagoon", "An estuary"],
    a: 0,
    why: "At a destructive (convergent) boundary the denser plate subducts, forming deep trenches and often volcanoes." },
  { id: "u1-tc4", topic: "u1-tectonics", type: "gap",
    q: "Complete the sentence.",
    segments: ["At a ", " boundary plates move apart and new sea floor forms, while at a ", " boundary one plate sinks beneath another to form a trench."],
    answers: ["constructive", "destructive"],
    bank: ["constructive", "destructive", "conservative", "tropical", "tidal"],
    why: "Constructive = plates apart (ridges); destructive = plates together (trenches)." },
  { id: "u1-tc5", topic: "u1-tectonics", type: "match",
    q: "Match each plate boundary to what happens there.",
    pairs: [["Constructive (divergent)", "Plates move apart; new sea floor forms"], ["Destructive (convergent)", "One plate sinks, forming a trench"], ["Conservative (transform)", "Plates slide past each other"]],
    why: "Three boundary types, each producing different features." },
  { id: "u1-tc6", topic: "u1-tectonics", type: "chain",
    q: "Build the explanation of sea-floor spreading at a mid-ocean ridge.",
    chunks: ["Two ocean plates move apart", "Magma rises into the gap from the mantle", "The magma cools to form new sea floor", "The ocean slowly widens over time"],
    why: "New crust forms at the ridge and spreads outward — sea-floor spreading." },

  /* ---------------------------------------------------- Unit 2: Upwelling */
  { id: "u2-up1", topic: "u2-upwelling", type: "choice",
    q: "What is upwelling?",
    options: ["The rising of deep, cold, nutrient-rich water to the surface", "The sinking of warm surface water to the deep sea", "The evaporation of water from the ocean surface", "The build-up of plastic in ocean gyres"],
    a: 0,
    why: "Upwelling brings deep, nutrient-rich water up to the sunlit surface.",
    reflect: { prompt: "In your own words, why does upwelling support such large fisheries?", model: "It keeps delivering nutrients from the deep to the sunlit surface, so producers bloom and feed the whole food web, right up to the fish people catch." } },
  { id: "u2-up2", topic: "u2-upwelling", type: "choice",
    q: "Why are upwelling regions among the most productive parts of the ocean?",
    options: ["The nutrients brought up fuel large phytoplankton growth, supporting rich food webs", "The water is too cold for any organisms to survive", "Sunlight cannot reach the nutrients", "There are no producers in upwelling zones"],
    a: 0,
    why: "Nutrients plus sunlight at the surface drive phytoplankton blooms, which feed rich fisheries." },
  { id: "u2-up3", topic: "u2-upwelling", type: "gap",
    q: "Complete the sentence.",
    segments: ["Upwelling brings deep, ", "-rich water to the surface, where it fuels the growth of ", " such as phytoplankton."],
    answers: ["nutrient", "producers"],
    bank: ["nutrient", "producers", "oxygen", "consumers", "plastic"],
    why: "Upwelled nutrients let surface producers photosynthesise and bloom." },
  { id: "u2-up4", topic: "u2-upwelling", type: "choice",
    q: "How does upwelling complete the nutrient cycle begun by marine snow?",
    options: ["Marine snow carries nutrients down; upwelling returns them to the surface", "Both remove oxygen from the deep sea", "Both are types of fishing method", "Marine snow rises while upwelling sinks"],
    a: 0,
    why: "Nutrients sink as marine snow and are later returned to the surface by upwelling — completing the cycle." },
  { id: "u2-up5", topic: "u2-upwelling", type: "choice",
    q: "What happens to a coastal fishery when upwelling is disrupted, for example during an El Niño?",
    options: ["Fewer nutrients reach the surface, so productivity and catches fall", "Fish become more numerous because the water warms", "Nutrients increase and blooms get bigger", "The fishery is completely unaffected"],
    a: 0,
    why: "Less upwelling means fewer surface nutrients, so phytoplankton and the fish depending on them decline.",
    bridge: true },
